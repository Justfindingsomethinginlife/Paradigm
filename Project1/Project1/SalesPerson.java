...
class SalesPersonList
{
    ...
    public void getTotalCommission(ProductList products) {
        for(int i=0;i<SalesPersonList.size();i++)
        {   
            SalesPerson temp = SalesPersonList.get(i);
            int product_index = check(products,temp.getProduct());
            double totalSales = temp.getQ1() + temp.getQ2() + temp.getQ3() + temp.getQ4();
            double unitPrice = products.getProductList().get(product_index).getUnit_price();
            
            if (temp.getType().equals("s")) 
            {   
                totalSales = totalSales * unitPrice *products.getProductList().get(product_index).getFlat_comm()/100;
                //return totalSales;
            ...
            {   
                ...
                double commissionQ1 = temp.getQ1() * unitPrice * products.getProductList().get(product_index).getQ1();
                double commissionQ2 = temp.getQ2() * unitPrice * products.getProductList().get(product_index).getQ2();
                double commissionQ3 = temp.getQ3() * unitPrice * products.getProductList().get(product_index).getQ3();
                double commissionQ4 = temp.getQ4() * unitPrice * products.getProductList().get(product_index).getQ4();
                
                //return commissionQ1 + commissionQ2 + commissionQ3 + commissionQ4;
                double total=commissionQ1 + commissionQ2 + commissionQ3 + commissionQ4;
                total = total/100;
    ...
    private void ProcessLine(String l, ProductList products) throws InvalidFormatException
    {
        String [] col = l.split(",");
            ...
            else if(check(products, col[2].trim()) == -1)                               throw new InvalidFormatException("For input: \"" + col[2].trim() + "\"");
    ...
    public void DisplaySales() //Used for debugging!
    {
        for(int i=0;i<SalesPersonList.size();i++)
        {
    ...
    public void Payment(ProductList products)
    {
