...
class SalesPersonList
{
    ...
    private static Boolean check(ProductList products, String code) //Should be implimented with Trie for a large dataset
    {   
    ...
    public void DisplaySales()
    {
        ...
        {
            System.out.println(SalesPersonList.get(i).getName() + SalesPersonList.get(i).getType() + SalesPersonList.get(i).getQ1() + SalesPersonList.get(i).getQ2() + SalesPersonList.get(i).getQ3() + SalesPersonList.get(i).getQ4());
        }
    }
